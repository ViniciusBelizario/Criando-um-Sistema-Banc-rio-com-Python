...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\n@@@ Operação falhou! Você não tem saldo suficinete. @@@")
        elif valor > 0:
            self._saldo -= valor
            print("\n=== Saque realizado om sucesso! ===")
            return True
        else:
            print("\n@@@ Operação falhou! O valor informado é ivalido. @@@")
